...
export default function FundraiserDashboard() {
  ...
  const isLoading = fundraiserQuery.isLoading || machinesQuery.isLoading || redemptionsQuery.isLoading;
  ...
  const releasedChecks = redemptions.filter((r: any) => r.status === "released").length;
  ...
  return (
    <FundraiserLayout>
      <div className="space-y-8">
        <div>
          <h1 className="text-3xl font-bold text-foreground mb-2">Welcome, {user?.name || "Fundraiser"}</h1>
          <p className="text-muted-foreground">Manage your assigned machines and redemption requests</p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {stats.map((stat, idx) => (
            <button
              ...
              className="p-6 rounded-lg bg-card border border-border hover:border-secondary/50 hover:shadow-md transition-all text-left"
            >
              <div className="flex items-start justify-between mb-4">
                <div className="p-3 bg-secondary/10 rounded-lg">{stat.icon}</div>
              </div>
          ...
          <div className="p-6 rounded-lg bg-card border border-border">
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="font-medium text-foreground">Fundraiser</span>
              </div>
              <div className="flex items-center justify-between">
